...
(50),
    ...
    CONSTRAINT FK_editor FOREIGN KEY
(editor) REFERENCES users
(nickname) ON
delete CASCADE ON
update CASCADE,
    CONSTRAINT FK_category_art FOREIGN KEY
...
delete CASCADE ON
update CASCADE,
    CONSTRAINT FK_article FOREIGN KEY
...
BEGIN
    ...
    UPDATE articles a
    SET a
    .views = a.views+1 WHERE a.id = _id;
...
insert into users
    (nickname, pwd, email, username, surname, usertype, ref)
values
    ('Simone', 'user', 'simone.meneghin@studenti.unipd.it', 'Simone', 'Meneghin', 'admin', null);
...
insert into categories
    (id, names)
values
    (null, 'categoriaHardware');
/*1*/
insert into categories
    (id, names)
values
    (null, 'categoriaEventi');/*2*/
insert into categories
    (id, names)
values
    (null, 'categoriaConsole');/*3*/
insert into categories
    (id, names)
values
    (null, 'categoriaVideogiochi');/*4*/
insert into categories
    (id, names)
values
...
values
    (null, 'html/News/LuccaRecord.html', '2019-11-03', 'Lucca Comics. Oltre 88mila biglietti: è record assoluto',
...
insert into articles
    ...
    (id, path, creation_date, title, description, category_title, article_type, views, category, editor)
values
    (null, 'html/News/WhatsappNews.html', '2020-01-01', 'Whatsapp: il virus di Capodanno con un messaggio ruba i dati dai telefoni iOs e Android',
...
insert into articles
    ...
    (id, path, creation_date, title, description, category_title, article_type, views, category, editor)
values
    (null, 'html/Altro/guidaFortnite.html', '2020-01-02', 'Fortnite: come ottenere il deltaplano 2020 gratis ',
...
insert into articles
    ...
    (id, path, creation_date, title, description, category_title, article_type, views, category, editor)
values
    (null, 'html/Altro/guidaPokemonGo.html', '2019-12-30', 'Pokémon GO, come sconfiggere Sierra del Team Rocketcon un solo Pokémon',
...
insert into articles
    ...
    (id, path, creation_date, title, description, category_title, article_type, views, category, editor)
values
    (null, 'html/Recensione/recensioneDeadStranding.html', '2019-12-04', 'Dead Stranding, la recensione - PS4',
...
insert into articles
    ...
    (id, path, creation_date, title, description, category_title, article_type, views, category, editor)
values
    (null, 'html/Recensioni/recensioneVampyr.html', '2018-06-05', 'Vampyr: la recensione',
...
insert into articles
    ...
    (id, path, creation_date, title, description, category_title, article_type, views, category, editor)
values
    (null, 'html/News/Cyberpunk-2077.html', '2019-11-28',
...
insert into articles
    ...
    (id, path, creation_date, title, description, category_title, article_type, views, category, editor)
values
    (null, 'html/Recensioni/Call-of-duty-MW-2019.html', '2019-09-25', 'Recensione: <span xml:lang="en">Call of Duty: Modern Warfare</span>',
...
insert into articles
    ...
    (id, path, creation_date, title, description, category_title, article_type, views, category, editor)
values
    (null, 'html/News/Xiaomimonitor.html', '2019-10-18', 'Xiaomi entra nel mondo dei monitor con<span xml:lang="en"> Mi Surface Display</span>, un 34 pollici <span xml:lang="en"><abbr title="Wide Quad HD">WQHD</abbr></span> con <span xml:lang="en">FreeSync</span>',
        '',
...
insert into articles
    ...
    (id, path, creation_date, title, description, category_title, article_type, views, category, editor)
values
    (null, 'html/Recensioni/recensioneStarWars.html', '2019-11-16', '<span xml:lang="en">Star Wars Jedi: Fallen Order</span>, la recensione - <span xml:lang="en"><abbr title="Play Station 4">PS4</abbr></span>',
        '',
...
insert into articles
    ...
    (id, path, creation_date, title, description, category_title, article_type, views, category, editor)
values
    (null, 'html/News/DeathStrandingPC.html', '2019-10-30', '<span xml:lang="en "> Death Stranding</span>: versione PC e periodo di uscita confermati',
        '',
...
insert into images
    (src, alt, article)
values
    ('images/Recensioni/dead-stranding/img0.jpg', '', '5');
insert into images
    (src, alt, article)
values
    ('images/Recensioni/vampyr/vampyr.jpg', '', '6');
insert into images
    (src, alt, article)
values
    ('images/News/Cyberpunk/CP20771-lowRes.jpg', '', '7');
insert into images
    (src, alt, article)
values
    ('images/Recensioni/cod-mw-2019/codmw.png', '', '8');
insert into images
    (src, alt, article)
values
    ('images/mi-surface-display.jpg', '', '9');
insert into images
    (src, alt, article)
values
    ('images/Recensioni/Star-Wars/starwars.png', '', '10');
insert into images
    (src, alt, article)
values
    ('images/death-stranding-image.jpg', '', '11');
insert into images
    (src, alt, article)
values
