...
insert into articles
    ...
    (id, path, creation_date, title, description, category_title, article_type, views, category, editor)
values
    (2, 'html/News/WhatsappNews.html', '2020-01-01', 'Whatsapp: il virus di Capodanno con un messaggio ruba i dati dai telefoni iOs e Android',
...
insert into articles
    ...
    (id, path, creation_date, title, description, category_title, article_type, views, category, editor)
values
    (3, 'html/Altro/guidaFortnite.html', '2020-01-02', 'Fortnite: come ottenere il deltaplano 2020 gratis ',
...
insert into articles
    ...
    (id, path, creation_date, title, description, category_title, article_type, views, category, editor)
values
    (4, 'html/Altro/guidaPokemonGo.html', '2019-12-30', 'Pokémon GO, come sconfiggere Sierra del Team Rocketcon un solo Pokémon',
...
insert into articles
    ...
    (id, path, creation_date, title, description, category_title, article_type, views, category, editor)
values
    (5, 'html/Recensione/recensioneDeadStranding.html', '2019-12-04', 'Dead Stranding, la recensione - PS4',
...
insert into articles
    ...
    (id, path, creation_date, title, description, category_title, article_type, views, category, editor)
values
    (6, 'html/Recensioni/recensioneVampyr.html', '2018-06-05', 'Vampyr: la recensione',
...
insert into articles
    ...
    (id, path, creation_date, title, description, category_title, article_type, views, category, editor)
values
    (7, 'html/News/Cyberpunk-2077.html', '2019-11-28',
...
insert into articles
    ...
    (id, path, creation_date, title, description, category_title, article_type, views, category, editor)
values
    (8, 'html/Recensioni/Call-of-duty-MW-2019.html', '2019-09-25', 'Recensione: <span xml:lang="en">Call of Duty: Modern Warfare</span>',
...
insert into articles
    ...
    (id, path, creation_date, title, description, category_title, article_type, views, category, editor)
values
    (9, 'html/News/Xiaomimonitor.html', '2019-10-18', 'Xiaomi entra nel mondo dei monitor con<span xml:lang="en"> Mi Surface Display</span>, un 34 pollici <span xml:lang="en"><abbr title="Wide Quad HD">WQHD</abbr></span> con <span xml:lang="en">FreeSync</span>',
        '',
...
insert into articles
    ...
    (id, path, creation_date, title, description, category_title, article_type, views, category, editor)
values
    (10, 'html/Recensioni/recensioneStarWars.html', '2019-11-16', '<span xml:lang="en">Star Wars Jedi: Fallen Order</span>, la recensione - <span xml:lang="en"><abbr title="Play Station 4">PS4</abbr></span>',
        '',
...
insert into articles
    ...
    (id, path, creation_date, title, description, category_title, article_type, views, category, editor)
values
    (11, 'html/News/DeathStrandingPC.html', '2019-10-30', '<span xml:lang="en "> Death Stranding</span>: versione PC e periodo di uscita confermati',
        '',
